...
echo "-----------------------------"
egg-gennoise cat=$CATALOG $NOISE_OPTIONS \
    out=$MAPDIR/$CATBASE-spitzer-irs16-noise.fits psf=spitzer-irs16.fits \
    aspix=0.9 rms=1.6e-2

egg-genmap   cat=$CATALOG $MAP_OPTIONS \
...
echo "-----------------------------"
egg-gennoise cat=$CATALOG $NOISE_OPTIONS \
    out=$MAPDIR/$CATBASE-spitzer-mips24-noise.fits psf=spitzer-mips24.fits \
...
echo "-----------------------------"
egg-gennoise cat=$CATALOG $NOISE_OPTIONS \
    out=$MAPDIR/$CATBASE-herschel-pacs70-noise.fits psf=herschel-pacs70.fits \
...
echo "-----------------------------"
egg-gennoise cat=$CATALOG $NOISE_OPTIONS \
    out=$MAPDIR/$CATBASE-herschel-pacs100-noise.fits psf=herschel-pacs100.fits \
...
echo "-----------------------------"
egg-gennoise cat=$CATALOG $NOISE_OPTIONS \
    out=$MAPDIR/$CATBASE-herschel-pacs160-noise.fits psf=herschel-pacs160.fits \
...
echo "-----------------------------"
egg-gennoise cat=$CATALOG $NOISE_OPTIONS \
    out=$MAPDIR/$CATBASE-herschel-spire250-noise.fits psf=herschel-spire250.fits \
...
echo "-----------------------------"
egg-gennoise cat=$CATALOG $NOISE_OPTIONS \
    out=$MAPDIR/$CATBASE-herschel-spire350-noise.fits psf=herschel-spire350.fits \
...
echo "-----------------------------"
egg-gennoise cat=$CATALOG $NOISE_OPTIONS \
    out=$MAPDIR/$CATBASE-herschel-spire500-noise.fits psf=herschel-spire500.fits \
