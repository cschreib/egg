...
void print_help() {
    ...
    print("ifni-genmap v1.0");
    print("usage: ifni-genmap cat.fits out=... psf=... noise_map=... band=... [options]\n");
    ...
    argdoc("psf", "[string]", "name of the file containing the PSF. Note: the performance "
        ...
        "large images unless you have very bright sources in the catalog.");
    argdoc("noise_map", "[string]", "name of the file containing the noise map (e.g, "
        "created by ifni-gennoise)");
