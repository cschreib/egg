...
int main(int argc, char* argv[]) {
    ...
    if (mf == "tomczak") {
        ...
        a_mstar2 = {10.6418, 10.7292, 10.6717, 10.8404, 10.9443, 11.6915};
        a_phistar1 = {0.000898887, 0.000718160, 0.000465684, 0.000213874, 0.000212404, 4.44724e-05};
        a_index1 = {-1.40000, -1.40000, -1.50000, -1.57000, -1.60000, -1.70000};
        a_phistar2 = {8.30778e-05, 0.000404045, 0.000417749, 0.000406023, 9.06860e-05, 8.59846e-06};
    ...
    vec1d decrease = g15_rhostar(0.5*(zl+zu)[ilast-_])/g15_rhostar(0.5*(zl[ilast] + zu[ilast]));
